...
module.exports = class MainRunner extends QEmitter {
    ...
    constructor(config) {
        ...
        qemitterUtils.passthroughEvent(this._retryMgr, this, [
    ...
    _runInBrowser(browserId, files, filterFn) {
        ...
        qemitterUtils.passthroughEvent(mochaRunner, this, [
        ...
        qemitterUtils.passthroughEventAsync(browserAgent, this, [
