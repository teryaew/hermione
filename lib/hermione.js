...
const qemitterUtils = require('qemitter/utils');
...
module.exports = class Hermione extends QEmitter {
    ...
    run(testPaths, options) {
        ...
        qemitterUtils.passthroughEvent(runner, this, RunnerEvents.SYNC);
        qemitterUtils.passthroughEventAsync(runner, this, RunnerEvents.ASYNC);
        qemitterUtils.passthroughEventAsync(signalHandler, this, RunnerEvents.EXIT);
