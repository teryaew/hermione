...
const passthroughEventAsync = require('qemitter/utils').passthroughEventAsync;
...
module.exports = class Hermione extends QEmitter {
    ...
    run(testPaths, options) {
        ...
        const syncEvents = _.difference(_.values(RunnerEvents), asyncEvents);

        passthroughEvent(runner, this, syncEvents);
        passthroughEventAsync(runner, this, asyncEvents);
